from cookbook.domain.recipe.models import Recipe, Owner, RecipeAdditionalInformation, NutritionValue, ScaleOption, \
    Ingredient, SimpleStep, NewRecipe
from cookbook.domain.recipe.repository import AbstractRecipeRepository


class LocalRecipeRepository(AbstractRecipeRepository):
    def __init__(self):
        self.recipe = dict(
